...
from .sopa_utils import ATTRS_KEY, SopaAttrs, SopaKeys
from .sopa_utils import get_boundaries, get_feature_key, get_spatial_element, get_spatial_image, to_intrinsic
...
def write_metadata(
    ...
    Note:
        This function alone is not enough to actually open an experiment. You will need at least to run `write_image`, or create all the outputs with `write`.
