...
class Para(_Constants):
    ...
    def __init__(self, 
        ...
        self.tile_size = self.CZI_FILES[self.ANCHOR_CYCLE].get_dims_shape()[0]['X'][1] # 2048
    ...
    def _sanity_yaml(self):
        ...
        segmentation_dict[self.ANCHOR_CHANNEL] = {'segmentation': False, 'vectorize': False}

        if self.EXTRA and 'CytoRNA' in self.EXTRA_NAMES:
            segmentation_dict['CytoRNA'] = {'segmentation': False, 'vectorize': False}
